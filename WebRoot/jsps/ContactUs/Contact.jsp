...
<head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/css/animate.css" charset="utf-8">
	<link rel="stylesheet" href="${pageContext.request.contextPath}/css/style.css" charset="utf-8">
	<link rel="stylesheet" href="${pageContext.request.contextPath}/css/indexcss.css" charset="utf-8">
	<link rel="stylesheet" href="${pageContext.request.contextPath}/css/responsive.css" charset="utf-8">
	<link rel="stylesheet" href="${pageContext.request.contextPath}/css/gdt-style.css" charset="utf-8">
	<title>联系我们</title>
	<style>
	body{margin:0 auto;}
	...
	.blog-list .blog-item .blog-title{text-align: center;}
		#content01{top:0px!important;}
	.wxq-foot{margin-top:0px;}
...
<body style="overflow: auto;">
    ...
    <script src="${pageContext.request.contextPath}/js/weixiaoqu.js"></script> 
  </body>
</html>