		...
		<div class="left0">
			<div class="content001">
				...
				<div class="col-lg-offset-1 col-lg-10 blog-area" style="padding-top: 30px;">
					<!--新闻列表 -->
					<c:forEach items="${information}" var="i" varStatus="informationStatus">
						<ul class="blog-list">
							<li class="blog-item">
								<article>
									<div class="blog-date" style="float:left;">
										<img src="<c:url value='/jsps/images/${i.image_i}'/>" width="150" height="115" alt="图片" style="width:auto;">   
									</div>
									<div class="blog-title">
										<a href="<c:url value='/InformationServlet?method=findByIid&iid=${i.iid }'/>" target="_blank">
											${i.title} 
										</a><br> 
										<span> ${i.time} </span>
										<span> ${i.writer} </span>
									...
									<div class="blog-bottom clearfix" >
										<span class="blog-date" style="cursor: pointer;text-indent: 28px;"> ${i.abstracts}
										</span> 
									</div>
								</article>
							</li>
