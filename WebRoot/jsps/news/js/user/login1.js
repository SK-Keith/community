$(function(){
	...
	$("#submit").hover(
		function() {
			$("#submit").attr("src", "/community/jsps/images/login2.jpg");
		},
		function() {
			$("#submit").attr("src", "/community/jsps/images/login1.jpg");
		}
	);
